...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://twitter.com/4geeksacademy"><i class="fab fa-twitter">${twitter}</i></a></li>
            <li><a href="https://github.com/4geeksacademy">${github}<i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/4geeksacademy">${linkedin}<i class="fab fa-linkedin"></i></a></li>
